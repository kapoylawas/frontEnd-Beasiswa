...
export default function KeagamanB() {
                    ...
                    {["1"].includes(selectedSertifikat) && (
                      <div className="row">
                        <div className="col-md-12">
                          <div className="mb-3">
                            ...
                            <input
                              ...
                              value={namaponpes}
                              onChange={(e) => setNamaponpes(e.target.value)}
                        ...
                        <div className="col-md-12">
                          <div className="mb-3">
                            ...
                            <textarea
                              ...
                              className="form-control"
                              value={alamatponpes}
                              onChange={(e) => setAlamatponpes(e.target.value)}
                        ...
                        <div className="col-md-12">
                          <div className="mb-3">
                            <label className="form-label fw-bold">
                              Upload Berkas Surat Ket Ponpes PDF
                              dan Maksimal 2MB
                            </label>
                            <input
                              type="file"
                    ...
                    {["2"].includes(selectedSertifikat) && (
                      <div className="row">
                        <div className="col-md-12">
                          <div className="mb-3">
                            <label className="form-label fw-bold">
                              Upload Berkas Surat Rekomendasi Kepala TPQ atau Madrasah Diniyah PDF
                              dan Maksimal 2MB
                            </label>
                            <input
                              type="file"
