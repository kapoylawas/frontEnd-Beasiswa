...
export default function AdminKesraB() {
  ...
  const fetchData = async (pageNumber = 1, keywords = "") => {
    ...
    await Api.get(
      `/api/admin/beasiswa/kesra2?search=${keywords}&page=${page}&status_ketrima=${selectStatusKetrima}`,
      {
        //header
        headers: {
          //header Bearer + Token
  ...
  const handleViewSpjmt = (kesraB) => {
    const imagespjmt = kesraB?.user?.imagespjmt;
    ...
    setSpjmtUrl(fileUrl);
    setSpjmtName(`SPJMT - ${kesraB.user.name}`);
                              ...
                              kesraBs.length > 0 ? (
                                kesraBs.map((kesraB, index) => (
                                  ...
                                  >
                                    ...
                                    <td className="text-center">
                                      {(kesraB.user.status_ketrima === "1" || kesraB.user.status_ketrima === 1) ? (
                                    ...
                                    <td className="text-center">
                                      {(kesraB.user.status_ketrima === "1" || kesraB.user.status_ketrima === 1) && (
                                        checkHasSpjmtFile(kesraB.user.imagespjmt) ? (
                                          <button
                                            onClick={() => handleViewSpjmt(kesraB)}
