...
export default function AdminKesra() {
  ...
  const fetchData = async (pageNumber = 1, keywords = "") => {
    ...
    await Api.get(`/api/admin/beasiswa/kesra?search=${keywords}&page=${page}&status_ketrima=${selectStatusKetrima}`, {
      //header
      headers: {
        //header Bearer + Token
  ...
  const handleViewSpjmt = (kesra) => {
    const imagespjmt = kesra?.user?.imagespjmt;
    ...
    setSpjmtUrl(fileUrl);
    setSpjmtName(`SPJMT - ${kesra.user.name}`);
                          ...
                          <tbody>
                            {
                              ...
                              kesras.length > 0 ? (
                                kesras.map((kesra, index) => (
                                  <tr
                                    className={`verif-${kesra.user.jenis_verif === 'belum'
                                        ? "belum"
                                  ...
                                  >
                                    ...
                                    <td className="text-center">
                                      {(kesra.user.status_ketrima === "1" || kesra.user.status_ketrima === 1) ? (
                                    ...
                                    <td className="text-center">
                                      {(kesra.user.status_ketrima === "1" || kesra.user.status_ketrima === 1) && (
                                        checkHasSpjmtFile(kesra.user.imagespjmt) ? (
                                          <button
                                            onClick={() => handleViewSpjmt(kesra)}
