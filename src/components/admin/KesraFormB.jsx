...
export default function KesraFormB({
  name,
  nik,
  kartuKeluarga,
  noHp,
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="fw-bold text-center">
                        ...
                        >
                          <option value="1">
                            Santriwan dan Santriwati yang berkuliah dan menetap
                            di Pondok Pesantren : Surat Ket Ponpes (Upload)
                          </option>
                          <option value="2">
                            Ustadz/ustadzah sebagai guru ngaji di TPA/TPQ/ Madin
                            : Surat Rekomendasi Kepala TPQ atau Madrasah Diniyah
                            (Upload)
                          </option>
                        </select>
                      </td>
