...
export default function KesraFormC({
  name,
  nik,
  kartuKeluarga,
  noHp,
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="fw-bold text-center">
                        ...
                        >
                          <option value="1">
                            Jajaran pengurus (Ketua, Wakil Ketua, Sekretaris,
                            Bendahara) aktifis organisasi keagamaan tingkat
                            Kabupaten/Kecamatan dan/ atau perguruan tinggi.
                          </option>
                        </select>
                      </td>
                    </tr>
